...
class MainController extends FOSRestController
{
    ...
    public function dashboardAction(Request $request){
        ...
        $newVideos = $em->getRepository("AppBundle:User")->getCandidateVideosApprove(['lm'=>5]);
    ...
    public function getBadgesAction(Request $request){
        ...
        $interviewAll = $em->getRepository("AppBundle:Interviews")->getCountAllInterviews([1,2,3]);
