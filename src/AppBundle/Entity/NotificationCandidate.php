...
class NotificationCandidate
{
    ...
    /**
     * @Assert\Choice({false,true},strict=true,message="notifyWhatsApp should be boolean type",groups={"updateNotify"})
     * @ORM\Column(type="boolean", nullable=true)
     */
    private $notifyWhatsApp;
    ...
    /**
     * @Assert\Choice({false,true},strict=true,message="Video Approved should be ON or OFF",groups={"updateNotify"})
     * @ORM\Column(type="boolean", nullable=true, options={"default":true})
     */
    private $videoApproveStatus;
     ...
     * @return mixed
     */
    public function getNotifyWhatsApp()
    {
        return $this->notifyWhatsApp;
    }

    /**
     * @param mixed $notifyWhatsApp
     */
    public function setNotifyWhatsApp($notifyWhatsApp)
    {
     ...
     * @return mixed
     */
    public function getVideoApproveStatus()
    {
        return $this->videoApproveStatus;
    }

    /**
     * @param mixed $videoApproveStatus
     */
    public function setVideoApproveStatus($videoApproveStatus)
    {
        $this->videoApproveStatus = $videoApproveStatus;
    }
