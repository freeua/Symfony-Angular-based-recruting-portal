...
const candidateRoutes: Routes = [
  ...
  { path: 'candidate', component: CandidateComponent, children: [
    ...
    { path: 'dashboard', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateDashboardComponent },
    ...
    { path: 'find_jobs', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateFindJobsComponent },
    { path: 'opportunities', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateYourOpportunitiesComponent },
    { path: 'job_alerts_new', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateJobAlertsNewComponent },
    { path: 'job_alerts_declined', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateJobAlertsDeclinedComponent },
    { path: 'job_alerts_expired', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateJobAlertsExpiredComponent },
    { path: 'applications', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateYourApplicationComponent },
    { path: 'awaiting_approval', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateAwaitingApprovalComponent },
    { path: 'approved_applications', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateApprovedApplicationsComponent },
    { path: 'declined_applications', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateDeclinedApplicationsComponent },
    { path: 'request_interviews', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateRequestedInterviewsComponent },
    { path: 'view_cv', canDeactivate: [ CanDeactivateGuardGuard ], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.candidateRole]}, component: CandidateViewCvComponent },
