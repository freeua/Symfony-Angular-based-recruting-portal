...
export class CandidateJobAlertsNewComponent implements OnInit {
  ...
  public async getCandidateProfileDetails(): Promise<void> {
    ...
    this.candidateProfileCV = this.candidateProfileDetails.profile.cvFiles;
   ...
   * @return {Promise<void>}
   */
  public async getOpportunitiesNew(dateStart: string, dateEnd: string, limit: string = ''): Promise<void> {
