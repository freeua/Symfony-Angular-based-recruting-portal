...
const adminRouters: Routes = [
  ...
  { path: 'admin', component: AdminComponent, children: [
    ...
    { path: 'dashboard', canDeactivate: [CanDeactivateGuardGuard], canActivate:[ AuthGuard, RoleGuard ], data:{roles:[Role.adminRole, Role.superAdminRole]}, component: AdminDashboardComponent },
